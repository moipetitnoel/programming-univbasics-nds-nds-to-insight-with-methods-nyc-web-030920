...
def directors_totals(nds)
  ...
  result = {"Stephen Spielberg" => 1357566430, "Russo Brothers" => 2281002470, #"James Cameron" => 2571020373, "Spike Lee" => 256624217, "Wachowski Siblings" => 806180282, "Robert Zemeckis" => 1273838385, "Quentin Tarantino" => que, "Martin Scorsese" => mar, "Francis Ford Coppola" => fra
  }
  nil
  result
end
